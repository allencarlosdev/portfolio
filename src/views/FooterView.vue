<template>
    <footer class="footer">
        <button class="footer__btn footer__btn--cv">
            <a rel="noopener noreferrer" href="https://drive.google.com/uc?export=download&id=1tqsX-5kkYNfklgVhrDEdh-Z5HPifX0-A" download="Carlos-Allen-CV" class="footer__link"><i class="fa-solid fa-circle-down"></i>Download CV</a>
        </button>
