          ...
          <img :class="{'copycat__img':(indexId != index+1),'copycat__imghover':(indexId === index+1)}" :src="project.image" alt="image of Copycat list" loading="lazy">
            <div class="copycat__card">
              ...
              <div class="copycat__buttons">
                <a rel="noopener noreferrer" class="copycat__btn" :href="project.linkGithub" target="_blank">Code</a>
                <a rel="noopener noreferrer" class="copycat__btn" :href="project.linkPage" target="_blank">Website</a>
              </div>
            </div>
        </li>
      </transition-group>
